...
do{
	...
	con.close();
	system("CLS");
	cout<<"\n\n\n\n\n\n\t\t\tEsta fue una aplicacion de:\n\n\t\t\tLuis Barajas      20031020065\n\n\t\t\tGiovanny Beltran  20031020105\n\n\t\tdel proyecto curricular de Ingenieria de Sistemas de la \n\n\t\t\tUniversidad Distrital F.J.C.\n\n\t\t\t\t2003-1."<<endl;
	system("PAUSE");
	for( a=0;a<(i+1);a++){
